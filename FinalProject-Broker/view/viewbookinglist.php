...
?>	  
	  ...
	  <td class="broker"><?php echo $row ['bookingid'] ?></td>
	  
	  <td><?php echo $row['clientname'] ?></td>
	  <td><?php echo $row['clientcontact'] ?></td>
	  <td><?php echo $row['bookedpropertytype']?></td>
	  <td><?php echo $row['bookedpropertylocation']?></td>
	  <td><?php echo $row['bookedtokenno']?></td>
	  <td><?php 
