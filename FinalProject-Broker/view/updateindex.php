...
<td><a href="updatechangesignup.php?edit_id=<?php echo $db_id ?>">Update</a> || <a href="signupdelete.php?edit_id=<?php echo $db_id ?>">Delete</a></td>
